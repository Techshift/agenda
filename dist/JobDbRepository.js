    ...
    async saveJob(job) {
        ...
        try {
            ...
            if (props.type === 'single') {
                ...
                log(`findOneAndUpdate(${props.name}) with type "single" ${result ? 'updated existing entry' : 'inserted new entry'}`);
                return this.processDbResult(job, result);
            }
            if (job.attrs.unique) {
                ...
                if ((_a = job.attrs.uniqueOpts) === null || _a === void 0 ? void 0 : _a.insertOnly) {
